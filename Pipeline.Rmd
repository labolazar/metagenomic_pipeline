...
This protocol was created with the help of Maggie, Val, JD and Ian from the Baker Laboratory at the University of Texas at Austin. Most of the programs are already installed on our server thanks to Mélanie Dominique and Karine Villeneuve. 
...
There alos seemed to be issues with the run_to_setup.bash. I solved this problem by changing these commands in the script : 
```{bash, highlight=TRUE, eval=FALSE}
...
python3.8 mebs_vis.py rock_assembly.tsv -o /home/kvilleneuve/Shotgun_Project/Melanie_Shotgun/rock_assembly_MEBS -im_format pdf -f pdf
``` 


perl mebs.pl -input ~/Shotgun_Project/Metagenomic_analyses/mebs/all_genomes_faa/ -type genomic -comp > genomes.tsv
python3.8 mebs_vis.py all.tsv -o all -im_format pdf -f pdf

perl mebs.pl -input ~/Shotgun_Project/Metagenomic_analyses/mebs/second_all_genomes_faaa qq -comp > 2-all-genomes.tsv
python3.8 mebs_vis.py 2-all-genomes.tsv -o all -im_format pdf -f pdf

perl mebs.pl -input ~/Shotgun_Project/Metagenomic_analyses/mebs/3_all_genomes_faa -type genomic > 3-all-genomes.tsv
python3.8 mebs_vis.py 3-all-genomes.tsv -o all -im_format pdf -f pdf

perl mebs.pl -input ~/Shotgun_Project/Metagenomic_analyses/mebs/input_faa/ -type genomic -comp > bins.tsv
