...
Copy all your raw `fastq.gz` files into the folder called `02_preprocess`. Move into the folder and unzip the files using [Parallel Implementation of GZip (pigz)](https://github.com/madler/pigz). 
