...
a) Move or copy the generated amino acids (`.faa`) to the user `genomics2` and log in to titan under this user

b) Activate the environnement

```{bash, eval=FALSE}
conda activate kofamscan
```

c) Execute the annotation using a foor loop and nohup 
