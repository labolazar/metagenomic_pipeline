...
Rename multiple files using a text file (example:`rename.txt`) consisting of the following 2 columns separated by a space : `old_name` `new_name` (No column name required)
```{bash, highlight=TRUE, eval=FALSE}
